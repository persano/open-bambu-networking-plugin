...
1. Subscribe directly via [OrcaCloud Plugin Page](https://cloud.orcaslicer.com/app/plugins/shared-plugins/5d35283e-0378-474d-8d3a-6d8f718fddeb).
2. In OrcaSlicer, open **Help** → **Plugins** (or **File** → **Plugins**) and click **Refresh**.
3. Activate **Open Bamboo Networking**.
